...
function getInput(id: string): HTMLInputElement {
  ...
  type RecordItem = { owner: string; amount: number;};
  let records: RecordItem[] = []; // stores records for calc
export function init(){
  ...
  registerBtn.addEventListener("click", () => {
    ...
    const taxType_input =
      document.querySelector<HTMLInputElement>('input[name="tax"]:checked');
